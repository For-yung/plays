			...
			*/
			...
			if (this.ckplayerConfig['style']['logo']) {
				if (this.ckplayerConfig['style']['logo']['file']) {
					...
					if (logoFile.substr(0, 15) == 'data:image/png;' || logoFile.substr(0, 15) == '/static/images/1.jpg;' || logoFile.substr(0, 16) == '/static/images/1.jpg;') {
						this.getByElement(logoID).innerHTML = '<img src="/static/images/1.jpg" border="0">'; //构建logo
					}
				}
			} else {
